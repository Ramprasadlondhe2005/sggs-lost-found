        ...
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
              {[
                { label: 'Total Items', value: stats.items.total || 0, icon: Package, color: 'text-primary' },
                { label: 'Total Users', value: stats.users.total || 0, icon: Users, color: 'text-success' },
                { label: 'Active Claims', value: stats.claims.total || 0, icon: ClipboardList, color: 'text-warning' },
                { label: 'Verification Rate', value: `${stats.claims.successRate || 0}%`, icon: ShieldCheck, color: 'text-info' },
              ].map((card, i) => (
